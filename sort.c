...
/*   Updated: 2024/05/11 14:14:58 by aranaivo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void move_the_max(t_list **pile_b, t_list **pile_a, t_list *max, t_list *min_cost)
{
...
void move_the_min(t_list **pile_b, t_list **pile_a, t_list *min_cost, t_list *min_on_a)
{
